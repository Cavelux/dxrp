...
public partial class ContainerNode
{
	...
	[Property, GooToken, Group( "Font", StartFolded = true ), Order( 90 )] public Color? FontColor { get; set; }
	/// <summary>Font face name.</summary>
	[Property, GooToken, Group( "Font", StartFolded = true ), Order( 90 ), FontName] public string FontFamily { get; set; }
	/// <summary>Text size.</summary>
	[Property, GooToken, Group( "Font", StartFolded = true ), Order( 90 ), Range( 0f, float.MaxValue, true, false )] public GooLength? FontSize { get; set; }
	/// <summary>Text antialiasing hint (Auto, Never, Always).</summary>
	[Property, GooToken, Group( "Font", StartFolded = true ), Order( 90 ), Editor( "goo-nullable-enum" )] public FontSmooth? FontSmooth { get; set; }
	/// <summary>Italic or oblique styling.</summary>
	[Property, GooToken, Group( "Font", StartFolded = true ), Order( 90 ), Editor( "goo-nullable-enum" )] public FontStyle? FontStyle { get; set; }
	/// <summary>Numeric glyph variant, e.g. TabularNums for fixed-width digits.</summary>
	[Property, GooToken, Group( "Font", StartFolded = true ), Order( 90 ), Editor( "goo-nullable-enum" )] public FontVariantNumeric? FontVariantNumeric { get; set; }
	/// <summary>Boldness from 100 to 900 (400 normal, 700 bold).</summary>
	[Property, GooToken, Group( "Font", StartFolded = true ), Order( 90 ), Editor( "goo-font-weight" )] public int? FontWeight { get; set; }
	...
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 )] public GooLength? LetterSpacing { get; set; }
	/// <summary>Height of each line of text (default 100%).</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Range( 0f, float.MaxValue, true, false )] public GooLength? LineHeight { get; set; }
	...
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Editor( "goo-nullable-enum" )] public TextAlign? TextAlign { get; set; }
	/// <summary>Angle in radians for a gradient fill painted onto the text.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Editor( "goo-float" ), Title( "Text Background Angle (Radians)" ), Step( 0.01f )] public float? TextBackgroundAngle { get; set; }
	/// <summary>Color of the underline, overline, or line-through.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 )] public Color? TextDecorationColor { get; set; }
	/// <summary>Which decoration lines to draw (underline, overline, line-through; flags).</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 )] public TextDecoration? TextDecorationLine { get; set; }
	/// <summary>Whether decoration lines skip over glyph descenders.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Editor( "goo-nullable-enum" )] public TextSkipInk? TextDecorationSkipInk { get; set; }
	/// <summary>Decoration line style (solid, double, dotted, dashed, wavy).</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Editor( "goo-nullable-enum" )] public TextDecorationStyle? TextDecorationStyle { get; set; }
	/// <summary>Thickness of the decoration line.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Range( 0f, float.MaxValue, true, false )] public GooLength? TextDecorationThickness { get; set; }
	/// <summary>Texture filtering mode used when rendering text.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Editor( "goo-nullable-enum" )] public FilterMode? TextFilter { get; set; }
	/// <summary>Vertical offset of the line-through.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 )] public GooLength? TextLineThroughOffset { get; set; }
	/// <summary>How clipped text is signalled (None, Ellipsis, Clip).</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Editor( "goo-nullable-enum" )] public TextOverflow? TextOverflow { get; set; }
	/// <summary>Vertical offset of the overline.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 )] public GooLength? TextOverlineOffset { get; set; }
	...
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 )] public GooShadow? TextShadow { get; set; }
	/// <summary>Color of the text outline stroke.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 )] public Color? TextStrokeColor { get; set; }
	/// <summary>Width of the text outline stroke.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Range( 0f, float.MaxValue, true, false )] public GooLength? TextStrokeWidth { get; set; }
	/// <summary>Case transform applied at render (Uppercase, Lowercase, Capitalize).</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Editor( "goo-nullable-enum" )] public TextTransform? TextTransform { get; set; }
	/// <summary>Vertical offset of the underline.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 )] public GooLength? TextUnderlineOffset { get; set; }
	...
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Editor( "goo-nullable-enum" )] public WhiteSpace? WhiteSpace { get; set; }
	/// <summary>Whether long words may break mid-word to avoid overflow.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 ), Editor( "goo-nullable-enum" )] public WordBreak? WordBreak { get; set; }
	/// <summary>Extra space between words.</summary>
	[Property, GooToken, Group( "Text", StartFolded = true ), Order( 100 )] public GooLength? WordSpacing { get; set; }
	...
	Goo.Container WithStyles( Goo.Container blob ) => blob with
	{
